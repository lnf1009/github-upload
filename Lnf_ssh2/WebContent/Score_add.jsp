...
<jsp:include page="top.jsp"></jsp:include>
 <jsp:include page="left.jsp"></jsp:include> 
  <div class="divright"  >
<form action="${pageContext.request.contextPath}/Score_addAction_add" method="post">
<table>
				<tr style="font-size:35px; ">
					<td colspan="2" align="center" >录入成绩信息</td>
				</tr>
				...
				<tr  style="font-size:25px; ">
					<td>成绩：</td>
					<td><input type="text" id="stuScore" name="stuScore" ></td>
				</tr>
				<tr style="font-size:25px; ">
