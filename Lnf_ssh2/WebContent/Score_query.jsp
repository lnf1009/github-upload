...
<form action="${pageContext.request.contextPath}/ScoreAction_update?${score.stuNum}" method="post">
...
<tr align="center">
<td width="105px">${score.stuNum}</td>
<td width="105px">${score.cNum}</td>
<td width="105px">${score.stuScore}</td>
<td width="105px"><a href="${pageContext.request.contextPath}/Score_addAction_delete?stuNum=${score.stuNum}" onclick="myFunction()">删除</a></td>
</c:forEach>
